		...
		<nav>
			...
			<div class="sidebar-links">
				<ul>
					...
					<li>
						<router-link class="tooltip" to="/formPlan">
							<img src="../assets/help.svg" alt="Planes">
							<span :class="{ hide: sidebarCollapsed }" class="link">Planes</span>
							<span class="tooltip__content">Planes</span>
						</router-link>
					</li>
				</ul>
			</div>
